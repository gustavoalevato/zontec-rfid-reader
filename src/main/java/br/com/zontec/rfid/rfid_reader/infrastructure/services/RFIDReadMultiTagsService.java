...
public class RFIDReadMultiTagsService  implements IRFIDReader {
	
	private static final Integer ANTENNA_POWER_DEFAULT = 20;
	
	private static final Integer SCAN_TIMEOUT = 3000; //milisegundos
	...
	public RFIDReadMultiTagsService(RFIDReaderConnection readerConnection) {
